...
const Menu: FC<MenuProps> = ({}) => {
  ...
  return (
    ...
    >
      ...
      <List link="https://www.instagram.com/sameers-b/" effect="slideUp">
        <Video /> Videos
      </List>
      ...
      <List
        target="_blank"
        link="https://www.instagram.com/sameers-b/"
        effect="slideUp"
      >
      ...
      <List
        target="_blank"
        link="https://github.com/sameers-b"
        effect="slideUp"
      >
      ...
      <List
        target="_blank"
        link="https://stackoverflow.com/users/18314715/sameer-singh"
        effect="slideUp"
      >
      ...
      <List
        target="_blank"
        link="https://www.linkedin.com/in/sameer-singh-a79178186/"
        effect="slideUp"
      >
